...
import com.tronline.driver.gcmHandlers.GcmBroadcastReceiver;
import com.tronline.driver.gcmHandlers.OnBootBroadcastReceiver;
...
public class ForegroundListner implements Application.ActivityLifecycleCallbacks,ComponentCallbacks2 {
    ...
    public boolean isBackground() {
        Log.e("asher","in background 1 "+isBackground());
        return !foreground;
    }
    ...
    public void onActivityDestroyed(Activity activity) {
        ...
        if(activity.getClass().getName().equalsIgnoreCase("com.tronline.driver.activity.MainActivity")) {
    ...
    public void onTrimMemory(final int level) {
        Log.e("asher","in background 2 "+level);
        if (level == ComponentCallbacks2.TRIM_MEMORY_UI_HIDDEN) { // Works for Activity
            // Get called every-time when application went to background.
            Log.e("asher","in background 3 "+level);
        }

package com.tronline.driver.utils.CarAnimation;
...
public class AnimateMarker {
    ...
    public static void animateMarker(final Context activity, final Location destination, final Marker marker, final GoogleMap googleMap) {
        if (marker != null) {

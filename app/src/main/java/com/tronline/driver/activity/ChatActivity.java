...
import com.tronline.driver.adapter.ChatAdapter;
...
import com.tronline.driver.model.ChatObject;
...
Commonutils.progressdialog_show(this,"Getting Chat");
    ...
    private void initiateSokect() {
        ...
        mSocket.on("new_message_from_user",onNewMessageFromProvider);
        mSocket.connect();
    }

...
import com.tronline.driver.utils.splash.SplashAnimationHelper;
    ...
    public void onTaskCompleted(String response, int serviceCode) {
        switch (serviceCode) {
           ...
           //     AndyUtils.removeProgressDialog();
                Log.d("krish", "version res" + response);
                if (response != null) {
                    try {
                                ...
                                versionbuilder.setMessage(getResources().getString(R.string.update_txt))
                                        ...
                                        .setPositiveButton(getResources().getString(R.string.update_txt_btn), new DialogInterface.OnClickListener() {
                                            public void onClick(DialogInterface dialog, int id) {
                                                //do things
                                                String mPlayStoreLink = "https://play.google.com/store/apps/details?id=com.tronline.driver";
